...
from app.api.routes import query, portfolio, health, stock_analysis, websocket, session, rag, ml_prediction
...
app.include_router(ml_prediction.router, prefix="/api", tags=["ML Prediction"])
